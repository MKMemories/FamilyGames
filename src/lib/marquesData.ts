...
export const MARQUES: Brand[] = [
  ...
  { id: 74, name: "LG", initial: "L", c1: "#a50034", c2: "#6b0022", emoji: "📱", category: "Tech", hint: "Électronique coréenne, « Life's Good »" },
  { id: 75, name: "Lenovo", initial: "L", c1: "#e2231a", c2: "#b31b14", emoji: "💻", category: "Tech", hint: "Ordinateurs et ThinkPad" },
  { id: 76, name: "Canon", initial: "C", c1: "#cc0000", c2: "#8f0000", emoji: "📷", category: "Tech", hint: "Appareils photo et imprimantes" },
  { id: 77, name: "JBL", initial: "J", c1: "#ff6600", c2: "#cc5200", emoji: "🔊", category: "Tech", hint: "Enceintes et casques audio" },
  { id: 78, name: "Bose", initial: "B", c1: "#111111", c2: "#333333", emoji: "🔊", category: "Tech", hint: "Le son haut de gamme" },
  { id: 79, name: "Facebook", initial: "f", c1: "#1877f2", c2: "#0a5dc2", emoji: "👍", category: "Réseaux", hint: "Le réseau social bleu au pouce" },
  { id: 80, name: "Telegram", initial: "T", c1: "#2aabee", c2: "#1c88bf", emoji: "✈️", category: "Réseaux", hint: "Messagerie, un avion en papier" },
  { id: 81, name: "LinkedIn", initial: "in", c1: "#0a66c2", c2: "#004182", emoji: "💼", category: "Réseaux", hint: "Le réseau professionnel" },
  { id: 82, name: "ChatGPT", initial: "◈", c1: "#10a37f", c2: "#0b7a5f", emoji: "🤖", category: "Tech", hint: "L'assistant d'intelligence artificielle" },
  { id: 83, name: "Zoom", initial: "Z", c1: "#2d8cff", c2: "#1f6fd6", emoji: "🎥", category: "Réseaux", hint: "Les visioconférences" },
  { id: 84, name: "Deezer", initial: "D", c1: "#a238ff", c2: "#7d1fd6", emoji: "🎧", category: "Divertissement", hint: "Musique en streaming" },

  { id: 85, name: "EA", initial: "EA", c1: "#ff4747", c2: "#111111", emoji: "🎮", category: "Gaming", hint: "Éditeur de FIFA et des Sims" },
  { id: 86, name: "Ubisoft", initial: "U", c1: "#0a0a0a", c2: "#333333", emoji: "🎮", category: "Gaming", hint: "Assassin's Creed, Just Dance" },
  { id: 87, name: "Epic Games", initial: "E", c1: "#2a2a2a", c2: "#111111", emoji: "🎮", category: "Gaming", hint: "Le créateur de Fortnite" },
  { id: 88, name: "Call of Duty", initial: "CoD", c1: "#1a1a1a", c2: "#333333", emoji: "🎯", category: "Gaming", hint: "Le jeu de tir militaire n°1" },
  { id: 89, name: "Pokémon", initial: "P", c1: "#ffcb05", c2: "#3d7dca", emoji: "⚡", category: "Gaming", hint: "« Attrapez-les tous ! »" },
  { id: 90, name: "Sega", initial: "S", c1: "#0064b5", c2: "#004b8a", emoji: "🎮", category: "Gaming", hint: "Sonic le hérisson" },
  { id: 91, name: "Razer", initial: "R", c1: "#00c800", c2: "#0a3d0a", emoji: "🐍", category: "Gaming", hint: "Matériel gaming, serpent vert" },

  { id: 92, name: "Reebok", initial: "R", c1: "#e2231a", c2: "#b31b14", emoji: "👟", category: "Sport", hint: "Baskets et fitness" },
  { id: 93, name: "Asics", initial: "A", c1: "#0033a0", c2: "#00246e", emoji: "👟", category: "Sport", hint: "Running japonais" },
  { id: 94, name: "Jordan", initial: "J", c1: "#111111", c2: "#c8102e", emoji: "🏀", category: "Sport", hint: "Baskets de basket légendaires" },
  { id: 95, name: "Decathlon", initial: "D", c1: "#0082c3", c2: "#005f8f", emoji: "⚽", category: "Sport", hint: "Le magasin de sport n°1" },
  { id: 96, name: "Under Armour", initial: "UA", c1: "#1d1d1d", c2: "#000000", emoji: "💪", category: "Sport", hint: "Vêtements de performance" },

  { id: 97, name: "Levi's", initial: "L", c1: "#b3122f", c2: "#8a0e24", emoji: "👖", category: "Mode", hint: "Les jeans américains" },
  { id: 98, name: "Calvin Klein", initial: "CK", c1: "#111111", c2: "#000000", emoji: "🩳", category: "Mode", hint: "Mode et sous-vêtements CK" },
  { id: 99, name: "Tommy Hilfiger", initial: "T", c1: "#c8102e", c2: "#00205b", emoji: "⛵", category: "Mode", hint: "Mode américaine chic" },
  { id: 100, name: "Shein", initial: "S", c1: "#111111", c2: "#000000", emoji: "👗", category: "Mode", hint: "Fast-fashion en ligne" },
  { id: 101, name: "Sephora", initial: "S", c1: "#111111", c2: "#000000", emoji: "💄", category: "Divers", hint: "Parfums et cosmétiques" },
  { id: 102, name: "Prada", initial: "P", c1: "#1a1a1a", c2: "#333333", emoji: "👜", category: "Luxe", hint: "Maison de luxe milanaise" },
  { id: 103, name: "Balenciaga", initial: "B", c1: "#111111", c2: "#000000", emoji: "👟", category: "Luxe", hint: "Luxe et streetwear" },

  { id: 104, name: "Pizza Hut", initial: "PH", c1: "#ee3124", c2: "#a51d16", emoji: "🍕", category: "Fast-food", hint: "La pizza au toit rouge" },
  { id: 105, name: "Krispy Kreme", initial: "K", c1: "#006241", c2: "#c8102e", emoji: "🍩", category: "Fast-food", hint: "Les donuts glacés" },
  { id: 106, name: "Dunkin'", initial: "D", c1: "#ff671f", c2: "#e11383", emoji: "🍩", category: "Fast-food", hint: "Donuts et café" },
  { id: 107, name: "Ben & Jerry's", initial: "B&J", c1: "#0072ce", c2: "#00843d", emoji: "🍦", category: "Snacks", hint: "Les glaces gourmandes" },
  { id: 108, name: "Sprite", initial: "S", c1: "#009a44", c2: "#00722f", emoji: "🥤", category: "Boissons", hint: "Soda citron-vert pétillant" },
  { id: 109, name: "Orangina", initial: "O", c1: "#ff7f00", c2: "#e35b00", emoji: "🍊", category: "Boissons", hint: "« Secouez-moi ! »" },
  { id: 110, name: "Nescafé", initial: "N", c1: "#a6093d", c2: "#6b0626", emoji: "☕", category: "Boissons", hint: "Le café instantané" },
  { id: 111, name: "M&M's", initial: "m", c1: "#2a9df4", c2: "#ff0000", emoji: "🍬", category: "Snacks", hint: "Les billes de chocolat colorées" },
  { id: 112, name: "Doritos", initial: "D", c1: "#d52b1e", c2: "#111111", emoji: "🧀", category: "Snacks", hint: "Les chips tortilla" },
  { id: 113, name: "Lay's", initial: "L", c1: "#ffd200", c2: "#e30613", emoji: "🥔", category: "Snacks", hint: "Les chips n°1" },
  { id: 114, name: "Pringles", initial: "P", c1: "#e30613", c2: "#ffcb05", emoji: "🥔", category: "Snacks", hint: "Les chips dans un tube" },
  { id: 115, name: "KitKat", initial: "K", c1: "#d70021", c2: "#8a0016", emoji: "🍫", category: "Snacks", hint: "« Have a break »" },
  { id: 116, name: "Snickers", initial: "S", c1: "#a6093d", c2: "#6b1a12", emoji: "🥜", category: "Snacks", hint: "Chocolat, caramel et cacahuètes" },
  { id: 117, name: "Milka", initial: "M", c1: "#7d69ac", c2: "#5a4a82", emoji: "🐄", category: "Snacks", hint: "Le chocolat au lait violet" },
  { id: 118, name: "Twix", initial: "T", c1: "#c8102e", c2: "#c8a24a", emoji: "🍫", category: "Snacks", hint: "Les deux barres chocolatées" },
  { id: 119, name: "Chupa Chups", initial: "C", c1: "#e30613", c2: "#ffcb05", emoji: "🍭", category: "Snacks", hint: "Les sucettes rondes" },

  { id: 120, name: "Audi", initial: "A", c1: "#bb0a30", c2: "#111111", emoji: "🚗", category: "Auto", hint: "Les 4 anneaux allemands" },
  { id: 121, name: "Volkswagen", initial: "VW", c1: "#001e50", c2: "#003a8c", emoji: "🚗", category: "Auto", hint: "« La voiture du peuple »" },
  { id: 122, name: "Porsche", initial: "P", c1: "#1a1a1a", c2: "#c8a24a", emoji: "🏎️", category: "Auto", hint: "Sportives allemandes de prestige" },
  { id: 123, name: "Renault", initial: "R", c1: "#ffcc33", c2: "#111111", emoji: "🚗", category: "Auto", hint: "Le losange français" },

  { id: 124, name: "eBay", initial: "e", c1: "#e53238", c2: "#0064d2", emoji: "🛒", category: "Divers", hint: "Les enchères en ligne" },
  { id: 125, name: "Temu", initial: "T", c1: "#ff6f00", c2: "#e35b00", emoji: "🛍️", category: "Divers", hint: "Le e-commerce à petits prix" },
  { id: 126, name: "Ryanair", initial: "R", c1: "#073590", c2: "#f1c933", emoji: "✈️", category: "Divers", hint: "La compagnie aérienne low-cost" },
  { id: 127, name: "Booking", initial: "B", c1: "#003580", c2: "#0057b8", emoji: "🏨", category: "Divers", hint: "Réserver un hôtel" },
];
